...
def job_title_doc_with_embedding(make_embedding):
    return {"_id": "jt_001", "title": "Full Stack Engineer", "embedding": make_embedding(10).tolist()}
...
def location_doc_with_embedding(make_embedding):
    return {"_id": "loc_001", "name": "San Francisco, CA", "embedding": make_embedding(20).tolist()}