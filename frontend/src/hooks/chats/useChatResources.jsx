...
import { fetchResourceCounts } from "../../utils/chats/chatResourceUtils";
import { initialState, chatResourcesReducer } from "../../reducers/chats/chatResourcesReducer";
import { getDefaultResources } from "../../../../shared/constants/chats/chatResourceTypes";
...
export const useChatResources = (conversation) => {
    ...
    const currentResources = resources[conversation?._id] || getDefaultResources();
